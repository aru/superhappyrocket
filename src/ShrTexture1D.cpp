...
SHR_IMPLEMENT_RTTI(shr, Texture, Texture1D);
SHR_IMPLEMENT_STREAM(Texture1D);
SHR_IMPLEMENT_FACTORY(Texture1D);
SHR_IMPLEMENT_DEFAULT_NAMES(Texture, Texture1D);
SHR_IMPLEMENT_DEFAULT_STREAM(Texture, Texture1D);
