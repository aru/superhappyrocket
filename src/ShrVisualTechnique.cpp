...
SHR_IMPLEMENT_RTTI(shr, Object, VisualTechnique);
SHR_IMPLEMENT_STREAM(VisualTechnique);
SHR_IMPLEMENT_FACTORY(VisualTechnique);
...
void VisualTechnique::Load (InStream& source)
{
    ...
    SHR_END_DEBUG_STREAM_LOAD(VisualTechnique, source);
}
//----------------------------------------------------------------------------
...
void VisualTechnique::Save (OutStream& target) const
{
    ...
    SHR_END_DEBUG_STREAM_SAVE(VisualTechnique, target);
}
//----------------------------------------------------------------------------
int VisualTechnique::GetStreamingSize () const
{
    ...
    size += numPasses*SHR_POINTERSIZE(mPasses[0]);
    return size;
}
//----------------------------------------------------------------------------
