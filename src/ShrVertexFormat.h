#ifndef SHRVERTEXFORMAT_H
#define SHRVERTEXFORMAT_H
...
class SHR_GRAPHICS_ITEM VertexFormat : public Object
{
    SHR_DECLARE_RTTI;
    SHR_DECLARE_NAMES;
    SHR_DECLARE_STREAM(VertexFormat);
...
public:
    ...
    enum SHR_GRAPHICS_ITEM AttributeType
    {
        AT_NONE,
        AT_FLOAT1,
        AT_FLOAT2,
    ...
    enum SHR_GRAPHICS_ITEM AttributeUsage
    {
        AU_NONE,
        AU_POSITION,      // attr 0
        AU_NORMAL,        // attr 2
...
protected:
    ...
    // information.
    class SHR_GRAPHICS_ITEM Element
    {
    public:
...
SHR_REGISTER_STREAM(VertexFormat);
typedef Pointer0<VertexFormat> VertexFormatPtr;
#include "ShrVertexFormat.inl"
