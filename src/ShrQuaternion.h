#ifndef SHRQUATERNION_H
#define SHRQUATERNION_H
...
public:
    ...
    // Special quaternions.
    SHR_MATHEMATICS_ITEM static const Quaternion ZERO;
    SHR_MATHEMATICS_ITEM static const Quaternion IDENTITY;
