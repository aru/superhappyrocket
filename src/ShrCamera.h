...
class SHR_GRAPHICS_ITEM Camera : public Object
{
    SHR_DECLARE_RTTI;
    SHR_DECLARE_NAMES;
    SHR_DECLARE_STREAM(Camera);
...
public:
    ...
    enum SHR_GRAPHICS_ITEM DepthType
    {
...
// Read the comments in ShrGraphicsLIB.h about this define.
private_internal:
...
SHR_REGISTER_STREAM(Camera);
typedef Pointer0<Camera> CameraPtr;
#include "ShrCamera.inl"
