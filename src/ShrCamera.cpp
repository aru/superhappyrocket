...
SHR_IMPLEMENT_RTTI(shr, Object, Camera);
SHR_IMPLEMENT_STREAM(Camera);
SHR_IMPLEMENT_FACTORY(Camera);
SHR_IMPLEMENT_DEFAULT_NAMES(Object, Camera);
...
#ifdef SHR_VALIDATE_CAMERA_FRAME_ONCE
    ,
...
void Camera::Load (InStream& source)
{
    ...
    SHR_END_DEBUG_STREAM_LOAD(Camera, source);
}
//----------------------------------------------------------------------------
...
void Camera::Save (OutStream& target) const
{
    ...
    SHR_END_DEBUG_STREAM_SAVE(Camera, target);
}
//----------------------------------------------------------------------------
int Camera::GetStreamingSize () const
{
    ...
    size += SHR_BOOLSIZE(mPreViewIsIdentity);
    size += sizeof(mPostProjectionMatrix);
    size += SHR_BOOLSIZE(mPostProjectionIsIdentity);
    size += SHR_BOOLSIZE(mIsPerspective);
    return size;
}
//----------------------------------------------------------------------------
