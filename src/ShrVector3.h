...
public:
    ...
    // Special vectors.
    SHR_MATHEMATICS_ITEM static const Vector3 ZERO;    // (0,0,0)
    SHR_MATHEMATICS_ITEM static const Vector3 UNIT_X;  // (1,0,0)
    SHR_MATHEMATICS_ITEM static const Vector3 UNIT_Y;  // (0,1,0)
    SHR_MATHEMATICS_ITEM static const Vector3 UNIT_Z;  // (0,0,1)
    SHR_MATHEMATICS_ITEM static const Vector3 ONE;     // (1,1,1)
