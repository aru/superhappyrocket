...
SHR_IMPLEMENT_RTTI(shr, Object, Texture);
SHR_IMPLEMENT_STREAM(Texture);
SHR_IMPLEMENT_ABSTRACT_FACTORY(Texture);
SHR_IMPLEMENT_DEFAULT_NAMES(Object, Texture);
...
void Texture::Load (InStream& source)
{
    ...
    SHR_END_DEBUG_STREAM_LOAD(Texture, source);
}
//----------------------------------------------------------------------------
...
void Texture::Save (OutStream& target) const
{
    ...
    SHR_END_DEBUG_STREAM_SAVE(Texture, target);
}
//----------------------------------------------------------------------------
int Texture::GetStreamingSize () const
{
    int size = Object::GetStreamingSize();
    size += SHR_ENUMSIZE(mFormat);
