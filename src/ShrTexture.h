...
class SHR_GRAPHICS_ITEM Texture : public Object
{
    SHR_DECLARE_RTTI;
    SHR_DECLARE_NAMES;
    SHR_DECLARE_STREAM(Texture);

public:
    // Currently supported formats.  More may be added as needed.
    enum SHR_GRAPHICS_ITEM Format
    {
        TF_NONE,
...
SHR_REGISTER_STREAM(Texture);
typedef Pointer0<Texture> TexturePtr;
#include "ShrTexture.inl"
