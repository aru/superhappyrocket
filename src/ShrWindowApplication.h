...
#ifndef SHR_WINDOWAPPLICATION_H
#define SHR_WINDOWAPPLICATION_H
...
protected:
	...
	WindowApplication (const char* windowTitle, int xPosition,
        int yPosition, int width, int height, const float& clearColor);
public:
...
#include "ShrWindowApplication.inl"

//----------------------------------------------------------------------------
#define SHR_WINDOW_APPLICATION(classname) \
SHR_IMPLEMENT_INITIALIZE(classname); \
SHR_IMPLEMENT_TERMINATE(classname); \
\
