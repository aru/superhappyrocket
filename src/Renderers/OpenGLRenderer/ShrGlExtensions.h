...
#ifndef SHRGLEXTENSIONS_H
#define SHRGLEXTENSIONS_H

#if defined(__gl_h_) || defined(__GL_H__)
#error gl.h included before ShrGlExtensions.h
#endif
#if defined(__glext_h_) || defined(__GLEXT_H_)
#error glext.h included before ShrGlExtensions.h
#endif
#if defined(__gl_ATI_h_)
#error glATI.h included before ShrGlExtensions.h
#endif
#define __gl_h_
#define __GL_H__
#define __glext_h_
...
#ifdef WIN32
// Microsoft Windows
#ifdef SHR_GRAPHICS_DLL_EXPORT
#define GT_EXTERN extern __declspec(dllexport)
#else
#ifdef SHR_GRAPHICS_DLL_IMPORT
