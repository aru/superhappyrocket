...
SHR_IMPLEMENT_RTTI(shr, Visual, Triangles);
SHR_IMPLEMENT_STREAM(Triangles);
SHR_IMPLEMENT_ABSTRACT_FACTORY(Triangles);
SHR_IMPLEMENT_DEFAULT_NAMES(Visual, Triangles);
SHR_IMPLEMENT_DEFAULT_STREAM(Visual, Triangles);
