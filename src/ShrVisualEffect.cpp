...
SHR_IMPLEMENT_RTTI(shr, Object, VisualEffect);
SHR_IMPLEMENT_STREAM(VisualEffect);
SHR_IMPLEMENT_FACTORY(VisualEffect);
...
//----------------------------------------------------------------------------
std::string VisualEffect::LoadString (FileIO& inFile)
{
    int length;
...
//----------------------------------------------------------------------------
void VisualEffect::SaveString (FileIO& outFile, std::string& name)
{
...
Object* VisualEffect::GetObjectByName (const std::string& name)
{
    ...
    for (/**/; iter != end; ++iter)
    {
        SHR_GET_OBJECT_BY_NAME((*iter), name, found);
    }
    ...
    std::vector<Object*>& objects)
{
    ...
    for (/**/; iter != end; ++iter)
    {
        SHR_GET_ALL_OBJECTS_BY_NAME((*iter), name, objects);
    }
}
//----------------------------------------------------------------------------
...
void VisualEffect::Load (InStream& source)
{
    ...
    SHR_END_DEBUG_STREAM_LOAD(VisualEffect, source);
}
//----------------------------------------------------------------------------
...
void VisualEffect::Save (OutStream& target) const
{
    ...
    SHR_END_DEBUG_STREAM_SAVE(VisualEffect, target);
}
//----------------------------------------------------------------------------
int VisualEffect::GetStreamingSize () const
{
    ...
    size += numTechniques*SHR_POINTERSIZE(mTechniques[0]);
    return size;
}
//----------------------------------------------------------------------------
