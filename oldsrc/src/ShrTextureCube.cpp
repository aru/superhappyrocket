...
SHR_IMPLEMENT_RTTI(shr, Texture, TextureCube);
SHR_IMPLEMENT_STREAM(TextureCube);
SHR_IMPLEMENT_FACTORY(TextureCube);
SHR_IMPLEMENT_DEFAULT_NAMES(Texture, TextureCube);
SHR_IMPLEMENT_DEFAULT_STREAM(Texture, TextureCube);
