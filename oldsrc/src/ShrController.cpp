...
SHR_IMPLEMENT_RTTI(shr, Object, Controller);
SHR_IMPLEMENT_STREAM(Controller);
SHR_IMPLEMENT_ABSTRACT_FACTORY(Controller);
...
void Controller::Load (InStream& source)
{
    ...
    SHR_END_DEBUG_STREAM_LOAD(Controller, source);
}
//----------------------------------------------------------------------------
...
void Controller::Save (OutStream& target) const
{
    ...
    SHR_END_DEBUG_STREAM_SAVE(Controller, target);
}
//----------------------------------------------------------------------------
int Controller::GetStreamingSize () const
{
    int size = Object::GetStreamingSize();
    size += SHR_ENUMSIZE(Repeat);
    size += sizeof(MinTime);
    size += sizeof(MaxTime);
    size += sizeof(Phase);
    size += sizeof(Frequency);
    size += SHR_BOOLSIZE(Active);
    size += SHR_POINTERSIZE(mObject);
    return size;
}
//----------------------------------------------------------------------------
