#ifndef SHRVISUALEFFECT_H
#define SHRVISUALEFFECT_H
...
class SHR_GRAPHICS_ITEM VisualEffect : public Object
{
    SHR_DECLARE_RTTI;
    SHR_DECLARE_NAMES;
    SHR_DECLARE_STREAM(VisualEffect);
...
SHR_REGISTER_STREAM(VisualEffect);
typedef Pointer0<VisualEffect> VisualEffectPtr;
#include "ShrVisualEffect.inl"
