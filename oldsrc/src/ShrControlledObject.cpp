...
SHR_IMPLEMENT_RTTI(shr, Object, ControlledObject);
SHR_IMPLEMENT_STREAM(ControlledObject);
SHR_IMPLEMENT_ABSTRACT_FACTORY(ControlledObject);
...
Object* ControlledObject::GetObjectByName (const std::string& name)
{
    ...
    for (int i = 0; i < mNumControllers; ++i)
    {
        SHR_GET_OBJECT_BY_NAME(mControllers[i], name, found);
    }
    ...
    std::vector<Object*>& objects)
{
    ...
    for (int i = 0; i < mNumControllers; ++i)
    {
        SHR_GET_ALL_OBJECTS_BY_NAME(mControllers[i], name, objects);
    }
}
//----------------------------------------------------------------------------
...
void ControlledObject::Load (InStream& source)
{
    ...
    SHR_END_DEBUG_STREAM_LOAD(ControlledObject, source);
}
//----------------------------------------------------------------------------
...
void ControlledObject::Save (OutStream& target) const
{
    ...
    SHR_END_DEBUG_STREAM_SAVE(ControlledObject, target);
}
//----------------------------------------------------------------------------
int ControlledObject::GetStreamingSize () const
{
    ...
    size += mNumControllers*SHR_POINTERSIZE(mControllers[0]);
    return size;
}
//----------------------------------------------------------------------------
