...
SHR_IMPLEMENT_RTTI(shr, Spatial, Visual);
SHR_IMPLEMENT_STREAM(Visual);
SHR_IMPLEMENT_ABSTRACT_FACTORY(Visual);
...
Object* Visual::GetObjectByName (const std::string& name)
{
    ...
    SHR_GET_OBJECT_BY_NAME(mVFormat, name, found);
    SHR_GET_OBJECT_BY_NAME(mVBuffer, name, found);
    SHR_GET_OBJECT_BY_NAME(mIBuffer, name, found);
    ...
    std::vector<Object*>& objects)
{
    ...
    SHR_GET_ALL_OBJECTS_BY_NAME(mVFormat, name, objects);
    SHR_GET_ALL_OBJECTS_BY_NAME(mVBuffer, name, objects);
    SHR_GET_ALL_OBJECTS_BY_NAME(mIBuffer, name, objects);
...
void Visual::Load (InStream& source)
{
    ...
    SHR_END_DEBUG_STREAM_LOAD(Visual, source);
}
//----------------------------------------------------------------------------
...
void Visual::Save (OutStream& target) const
{
    ...
    SHR_END_DEBUG_STREAM_SAVE(Visual, target);
}
//----------------------------------------------------------------------------
int Visual::GetStreamingSize () const
{
    int size = Spatial::GetStreamingSize();
    size += SHR_ENUMSIZE(mType);
    size += sizeof(mModelBound);
    size += SHR_POINTERSIZE(mVFormat);
    size += SHR_POINTERSIZE(mVBuffer);
    size += SHR_POINTERSIZE(mIBuffer);
