...
SHR_IMPLEMENT_RTTI(shr, Texture, Texture2D);
SHR_IMPLEMENT_STREAM(Texture2D);
SHR_IMPLEMENT_FACTORY(Texture2D);
SHR_IMPLEMENT_DEFAULT_NAMES(Texture, Texture2D);
SHR_IMPLEMENT_DEFAULT_STREAM(Texture, Texture2D);
