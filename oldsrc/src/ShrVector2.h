...
public:
    ...
    // Special vectors.
    SHR_MATHEMATICS_ITEM static const Vector2 ZERO;    // (0,0)
    SHR_MATHEMATICS_ITEM static const Vector2 UNIT_X;  // (1,0)
    SHR_MATHEMATICS_ITEM static const Vector2 UNIT_Y;  // (0,1)
    SHR_MATHEMATICS_ITEM static const Vector2 ONE;     // (1,1)
