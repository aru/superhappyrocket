...
//----------------------------------------------------------------------------
const Rtti Object::TYPE("shr.Object", 0);
//----------------------------------------------------------------------------
...
void Object::Load (InStream& source)
{
    ...
    SHR_END_DEBUG_STREAM_LOAD(Object, source);
}
//----------------------------------------------------------------------------
...
void Object::Save (OutStream& target) const
{
    ...
    SHR_END_DEBUG_STREAM_SAVE(Object, target);
}
//----------------------------------------------------------------------------
int Object::GetStreamingSize () const
{
    // The RTTI name.
    int size = SHR_STRINGSIZE(GetRttiType().GetName());

    // The unique identifier for the object.
    size += sizeof(unsigned int);

    // The name of the object.
    size += SHR_STRINGSIZE(mName);
