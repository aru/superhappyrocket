...
SHR_IMPLEMENT_RTTI(shr, Triangles, TriStrip);
SHR_IMPLEMENT_STREAM(TriStrip);
SHR_IMPLEMENT_FACTORY(TriStrip);
SHR_IMPLEMENT_DEFAULT_NAMES(Triangles, TriStrip);
SHR_IMPLEMENT_DEFAULT_STREAM(Triangles, TriStrip);
