...
SHR_IMPLEMENT_RTTI(shr, Triangles, TriFan);
SHR_IMPLEMENT_STREAM(TriFan);
SHR_IMPLEMENT_FACTORY(TriFan);
SHR_IMPLEMENT_DEFAULT_NAMES(Triangles, TriFan);
SHR_IMPLEMENT_DEFAULT_STREAM(Triangles, TriFan);
