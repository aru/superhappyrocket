...
class SHR_GRAPHICS_ITEM Shader : public Object
{
    SHR_DECLARE_RTTI;
    SHR_DECLARE_NAMES;
    SHR_DECLARE_STREAM(Shader);
...
public:
    ...
    enum SHR_GRAPHICS_ITEM VariableType
    {
        VT_NONE,
    ...
    enum SHR_GRAPHICS_ITEM VariableSemantic
    {
        VS_NONE,
        VS_POSITION,        // ATTR0
    ...
    enum SHR_GRAPHICS_ITEM SamplerType
    {
        ST_NONE,
        ST_1D,
        ST_2D,
    ...
    enum SHR_GRAPHICS_ITEM SamplerFilter
    {
        SF_NONE,
    ...
    enum SHR_GRAPHICS_ITEM SamplerCoordinate
    {
        SC_NONE,
        SC_CLAMP,
        SC_REPEAT,
...
SHR_REGISTER_STREAM(Shader);
typedef Pointer0<Shader> ShaderPtr;
#include "ShrShader.inl"
