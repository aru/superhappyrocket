...
SHR_IMPLEMENT_RTTI(shr, Texture, Texture3D);
SHR_IMPLEMENT_STREAM(Texture3D);
SHR_IMPLEMENT_FACTORY(Texture3D);
SHR_IMPLEMENT_DEFAULT_NAMES(Texture, Texture3D);
SHR_IMPLEMENT_DEFAULT_STREAM(Texture, Texture3D);
